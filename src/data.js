export const data = [
  {
    ...
    selected: true,
    items: [
      { id: 0, label: "Blue 50", filename: "blue50", selected: true },
      { id: 1, label: "Blue 60", filename: "blue60", selected: false },
      { id: 2, label: "Blue 70", filename: "blue70", selected: false },
      { id: 3, label: "Green 60", filename: "green60", selected: false },
      { id: 4, label: "Green 70", filename: "green70", selected: false },
      { id: 5, label: "Grey 40", filename: "grey40", selected: false },
      { id: 6, label: "Grey 70", filename: "grey70", selected: false },
      { id: 7, label: "Grey 80", filename: "grey80", selected: false },
      { id: 8, label: "Red 50", filename: "red50", selected: false },
      { id: 9, label: "Red 60", filename: "red60", selected: false },
      { id: 10, label: "Red 70", filename: "red70", selected: false },
      { id: 11, label: "Yellow 50", filename: "yellow50", selected: false },
      { id: 12, label: "Yellow 60", filename: "yellow60", selected: false },
      { id: 13, label: "Yellow 70", filename: "yellow70", selected: false },
    ],
  },
  {
    id: 1,
  ...
  },
  {
    ...
    selected: false,
    items: [
      { id: 0, label: "Headphones", filename: "headphone", selected: true },
